        ...
        <form method="post" action="{{ route('register') }}">
            @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password" id="password" placeholder="Choose a password" value="{{ old('password') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Repeat Password" value="{{ old('password_confirmation') }}"
